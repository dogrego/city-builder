...
const BuildingData& Buildings::GetBuildingData(BuildingType type) {
    switch (type) {
    case STUDIO_FLAT: return studioFlatData;
    case SMALL_HOUSE: return smallHouseData;
    case FAMILY_HOUSE: return familyHouseData;
    case TOWER: return towerData;
    case APARTMENT_BLOCK: return apartmentBlockData;
    default: return studioFlatData;
    }
}
